<div class="row bs-wizard" style="border-bottom:0;">
    ...
    <div class="col-md-4 bs-wizard-step {{ Request::is('bestellen/bezorgmoment') || Request::is('bestellen/bevestigen') ? 'complete' : 'disabled'}}">
        <!-- complete -->
    ...
    <div class="col-md-4 bs-wizard-step {{ Request::is('bestellen/bevestigen') ? 'complete' : 'disabled'}}">
        <!-- complete -->
